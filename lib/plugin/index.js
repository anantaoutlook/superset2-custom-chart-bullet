...
class SupersetBulletChartV3 extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    const metadata = new _core.ChartMetadata({
      ...
      name: (0, _core.t)('superset2-custom-chart-bullet'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../Superset2CustomChartBullet'))),
      metadata,
